 ...
 * value by calculating the sha1 hash of these values cutting out the first 32
 * chars.
 *
 ...
 */
class Sha1 implements ByteProviderInterface
{
    /**
    ...
    /**
     * The namespace to create the sha1 from.
     *
     * @var \Techworker\Uuid
     */
    protected $namespace;
     ...
     * Constructor.
     *
     * Creates a new instance of the Techworker\Uuid\ByteProvider\Hash\Sha1
     * class.
     *
    ...
    public function __construct($value, Uuid $namespace = null)
    {
        ...
        if(!is_string($this->value)) {
            throw new HashException("sha1");
        }
    }

    /**
     * Returns a 16 Byte sized ByteList from the sha1 hash.
     *
     * @return Uuid\ByteList
     */
    public function provide()
    {
        return (new Hex(substr(
            sha1($this->namespace->toByteString() . $this->value), 0, 32)
        ))->provide();
    }
}